...
const SEO_TITLE = "Privacy Policy | AdRefresh";

// Variable 2: Meta Description
const SEO_DESCRIPTION = "Read AdRefresh's privacy policy to understand how we collect, use, and protect your personal information when using our website and services.";
  ...
  return (
    <section className="relative bg-white">
      ...
      <div className="relative z-10">
        ...
        {/* White Content Area */}
        <div className="w-full px-6 md:px-10 py-20 space-y-12 text-gray-700 leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <p>
              <span className="font-semibold text-gray-900">Personal Information:</span> When you fill out forms, subscribe to our
            ...
            <p>
              <span className="font-semibold text-gray-900">Usage Data:</span> We may also collect data on how you interact with our
          ...
          <div className="space-y-4">
            ...
            <p>
              <span className="font-semibold text-gray-900">Service Delivery:</span> We use your personal information to deliver the
              services you request, address your inquiries, and enhance our offerings.
            </p>

            <p>
              <span className="font-semibold text-gray-900">Marketing Communications:</span> With your consent, we may send you
              updates, newsletters, and marketing materials. You can opt out of receiving these
              communications at any time.
            </p>

            <p>
              <span className="font-semibold text-gray-900">Website Improvement:</span> The usage data helps us analyze trends,
          ...
          <div className="space-y-4">
            ...
            <p>
              <span className="font-semibold text-gray-900">Access and Correction:</span> You have the right to review the personal
              information we have about you and to request any necessary updates.
            </p>

            <p>
              <span className="font-semibold text-gray-900">Data Deletion:</span> You can request the deletion of your personal
              information from our records, subject to legal and contractual obligations.
            </p>

            <p>
              <span className="font-semibold text-gray-900">Opt-Out:</span> You can opt out of marketing communications by following
          ...
          <div className="space-y-4">
            ...
            <p>
              <span className="font-semibold text-gray-900">Email:</span> contact@adrefresh.com <br />
              <span className="font-semibold text-gray-900">Phone:</span> +91 93923 20142
            </p>
          </div>
