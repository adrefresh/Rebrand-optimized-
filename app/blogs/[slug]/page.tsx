  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-[#1A0F2E]">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] rounded-full bg-[#813DFF]/25 blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10 lg:px-16 pt-32 pb-0">
          ...
          <div className="relative w-full h-[220px] sm:h-[360px] md:h-[460px] lg:h-[520px] rounded-t-3xl overflow-hidden mt-10">
            <Image
              src={blog.coverImage}
              alt={blog.title}
              fill
