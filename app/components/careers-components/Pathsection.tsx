  ...
  const steps = [
    {
      ...
      img: `${basePath}/images/careers-images/1.jpg`,
    },
    {
      ...
      img: `${basePath}/images/careers-images/careers2.jpg`,
    },
    {
      ...
      img: `${basePath}/images/careers-images/careers3.jpg`,
    },
    {
      ...
      img: `${basePath}/images/careers-images/4.jpg`,
    },
    {
      ...
      img: `${basePath}/images/careers-images/5.jpg`,
    },
  ];
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="relative pl-12 lg:hidden block w-full">
                ...
                {/* Mobile: Two Images Side by Side - B&W and Color */}
                <div className="flex gap-3">
                  {/* B&W Image */}
                  <div className="w-1/2 h-[170px] rounded-xl overflow-hidden shadow-lg">
                    <img
                      src={step.img}
                      loading="lazy"
                      className="w-full h-full object-cover grayscale"
                      alt={`${step.title} - Black & White`}
                    />
                  </div>
                  {/* Color Image */}
                  <div className="w-1/2 h-[170px] rounded-xl overflow-hidden shadow-lg">
              ...
              {/* DESKTOP IMAGES - Two Images Side by Side */}
              <div className="hidden lg:block pl-10">
                <div className="flex gap-3">
                  {/* B&W Image */}
                  <div className="w-[250px] h-[150px] rounded-xl overflow-hidden shadow-lg">
                    <img
                      src={step.img}
                      loading="lazy"
                      className="w-full h-full object-cover grayscale"
                  ...
                  {/* Color Image */}
                  <div className="w-[250px] h-[150px] z-10 rounded-xl overflow-hidden shadow-lg  ml-[-40px] mt-15">
                    <img
                      src={step.img}
                      loading="lazy"
                      className="w-full h-full object-cover"
