...
// ✅ FIXED: Moved outside component so it's not recreated on every render
const platforms = [
  { name: "logo1",  img: `${BASE_PATH}/images/platform-experience-images/logo1.png` },
  { name: "logo2",  img: `${BASE_PATH}/images/platform-experience-images/logo2.png` },
  { name: "logo3",  img: `${BASE_PATH}/images/platform-experience-images/logo3.png` },
  ...
  { name: "logo17", img: `${BASE_PATH}/images/platform-experience-images/logo17.png` },
  { name: "logo18", img: `${BASE_PATH}/images/platform-experience-images/logo18.png` },
  { name: "pmatic",  img: `${BASE_PATH}/images/platform-experience-images/pmatic.png` },
  { name: "logo19", img: `${BASE_PATH}/images/platform-experience-images/logo19.png` },
  { name: "logo20", img: `${BASE_PATH}/images/platform-experience-images/logo20.png` },
  { name: "logo21", img: `${BASE_PATH}/images/platform-experience-images/logo21.png` },
  { name: "logo22", img: `${BASE_PATH}/images/platform-experience-images/logo22.png` },
...
export default function Section7() {
  return (
    // ✅ FIXED: Added explicit min-h to prevent CLS (section had no height defined)
    <section className="relative w-full overflow-hidden bg-white py-10 min-h-[280px]">
      <div className="pointer-events-none relative">
        <Marquee items={line1} top="mt-[10px]" />
        <Marquee items={line2} top="mt-[50px]" reverse />
        <Marquee items={line3} top="mt-[50px]" />
      ...
      <style jsx global>{`
        ...
        .animate-marquee {
          animation: marquee 60s linear infinite;
          /* ✅ FIXED: will-change tells browser to composite this layer
             BUT only apply it here — not globally — to avoid memory overhead */
          will-change: transform;
        }
        .animate-marquee-reverse {
          animation: marquee-reverse 60s linear infinite;
        ...
        /* ✅ ADDED: Pause on reduced motion for accessibility */
          ...
          <div key={copy} className="flex gap-[70px] pr-[70px]">
            {items.map((p, i) => (
              <div
                ...
                "
              >
                {/* ✅ FIXED: Added explicit width/height container — prevents CLS */}
                <div className="relative w-[120px] h-[60px]">
                  <Image
                    src={p.img}
                    alt={p.name}
                    fill
                    // ✅ FIXED: All marquee logos are lazy (they're decorative/below fold)
                    loading="lazy"
                    // ✅ FIXED: unoptimized required for static export
                    unoptimized
                    sizes="120px"
                    className="object-contain grayscale opacity-[0.6] transition-opacity duration-300 hover:opacity-100"
                  />
                </div>
              </div>
            ))}
