...
// // //       {/* TITLE */}
// // //       <h1 className="py-6 text-center text-[3.2rem] font-extrabold sm:text-[2.6rem]">
// // //         WHY US
// // //       </h1>
...
// // //           relative ml-auto
// // //           max-w-[1400px]
// // //           pr-[2vw] pl-[1vw] pb-[20px]
// // //           hidden sm:grid
// // //           grid-cols-[1fr_60px_1fr]
// // //         "
// // //       >
// // //         {/* LEFT */}
// // //         <div className="flex flex-col items-center text-left gap-[100px] pt-[20px] pr-[12px] ml-[40%]">
// // //           <div className="ml-10">
// // //             <h2 className="text-[2rem] font-extrabold">A CORE OF  <div className="relative inline-block mt-2">
// // //               <span className="absolute inset-[-10px_-18px] bg-[var(--green-tint-30)] opacity-70 blur-[36px]" />
// // //               <span className="relative text-[2.4rem] font-extrabold">
// // //                 FOCUS
// // //               </span>
// // //             </div></h2>
...
// // //           {/* <div>
// // //             <h2 className="text-[2rem] font-extrabold">A LAYER OF</h2>
// // //             <div className="relative inline-block mt-2">
// // //               <span className="absolute inset-[-10px_0] bg-[var(--green-tint-30)] opacity-70 blur-[40px]" />
// // //               <span className="relative text-[2.4rem] font-extrabold rotate-[-6deg] skew-x-[-10deg] scale-x-[1.05]">
// // //                 FLEXIBILITY
// // //               </span>
// // //             </div>
// // //           </div> */}
...
// // //               <span className="relative text-[2.4rem] font-extrabold text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.7)]">
// // //                 TRANSPARENCY
// // //               </span>
// // //             </div>
// // //           </div>
...
// //       >
// //         {/* LEFT */}
// //         <div className="flex flex-col items-center text-left gap-[100px] pt-[20px] pr-[12px] ml-[10%]">

// //           {/* CORE */}
// //           <div className="ml-2">
// //             <h2 className="text-[2rem] font-extrabold flex items-center gap-2">
// //               A CORE OF
...
// //                   textAnchor="middle"
// //                 >
// //                   <textPath href="#curve-flex-small" startOffset="55%">
// //                     FLEXIBILITY
// //                   </textPath>
// //                 </text>
// //               </svg>
...
// //       {/* ================= MOBILE (UNCHANGED) ================= */}
// //       {/* YOUR MOBILE CODE IS KEPT EXACTLY AS YOU SENT */}
// //     </section>
// //   );
// // }
...
// //       >
// //         {/* LEFT */}
// //         <div className="flex flex-col items-center text-left gap-[100px] pt-[20px] pr-[12px] ml-[5%]">
// //           {/* CORE */}
...
// //           {/* TRANSPARENCY */}
// //           <div className="ml-2 ">
// //             <h2 className=" mb-[50px] text-[2rem] font-extrabold flex items-center gap-2   ">
// //               A CULTURE OF
// //               <span className="relative inline-block mt-25">
// //                 <span className="absolute inset-[-8px_0] bg-[var(--green-tint-30)] opacity-60 blur-[18px]" />
// //                 <span className="relative text-[2.4rem] font-extrabold text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.7)]">
// //                   TRANSPARENCY
// //                 </span>
...
//           {/* TRANSPARENCY */}
//           <div className="ml-2">
//             <h2 className="text-[2rem] font-extrabold flex items-center gap-2 sm:mb-[-50px]">
//               A CULTURE OF
//               <span className="relative inline-block mt-25">
//                 <span className="absolute inset-[-8px_0] bg-[var(--green-tint-30)] opacity-60 blur-[18px]" />
//                 <span className="relative text-[2.4rem] font-extrabold text-transparent [-webkit-text-stroke:1px_rgba(255,255,255,0.7)]">
...
//       {/* ================= MOBILE (UNCHANGED) ================= */}
//       {/* ... mobile section exactly same as before ... */}
//     </section>
//   );
// }
"use client";
