...
//         {/* LINKS */}
//         <nav className="mt-[80px] sm:mt-[90px] pr-4 sm:pr-[20px] flex flex-col gap-[18px] text-right">
//           <Link
//             onClick={() => navigate("/")}
//             href="/"
//             prefetch
...
//               Services
//               <span
//                 className={`text-[2.6rem] transition-transform duration-300 group-hover:rotate-180 ${
//                   open ? "rotate-180" : ""
//                 }`}
//               >
//                 <IoIosArrowDown />
