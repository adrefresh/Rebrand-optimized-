...
export default function Header() {
  ...
  return (
    <>
      ...
      <header
        ...
        className={`fixed top-0 left-0 w-screen px-2.5-[16px] sm:py-5 z-999999 transition-[background,transform] duration-300
        ...
        <div className="mx-auto max-w-350 px-4 sm:px-6 md:px-8 lg:px-10 flex items-center justify-between">
          ...
          <Link href="/" aria-label="Go to Home" prefetch>
            <div className="w-42.5 h-10 flex items-center">
              <div className="relative w-30 sm:w-35 md:w-40 lg:w-42.5[40px]">
  <Image
  ...
  />
      ...
      <div
        onClick={closeMenu}
        className={`
          fixed inset-0 z-999998 transition-all duration-350 
          ${
            menuOpen
